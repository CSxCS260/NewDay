...
public class CompletedMyRecyclerViewAdapter extends RecyclerView.Adapter<CompletedMyRecyclerViewAdapter.ViewHolder> {
    ...
    CompletedMyRecyclerViewAdapter(ItemClickListener itemClickListener, Context context, ArrayList<String> data1, ArrayList<String> data2, ArrayList<String> data3, ArrayList<String> data4, ArrayList<String> data5, ArrayList<String> data6) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (switchPref) {
            ...
            TextView textView1 = view.findViewById(R.id.titleBold);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        String theDescription = tempDescription+ " @ " + postTime;
